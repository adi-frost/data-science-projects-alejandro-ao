...
# not to be used for larger datasets or production settings
def get_clean_data():
...
def get_radar_chart(input_data):
    ...
    fig.add_trace(go.Scatterpolar( # Mean
        r=[
    ...
    fig.add_trace(go.Scatterpolar(  # Standard Error
        r=[
    ...
    fig.add_trace(go.Scatterpolar(    # Worst Value
        r=[
...
def add_predictions(input_data):
    ...
    st.write("This app can assist medical professionals in making a diagnosis, but should not be used as a substitute for \
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer from your tissue sample.  \
                This app predicts using a machine learning model whether a breast mass is benign or malignant based on the \
                measurements it receives from your cytosis lab. You can also update the measurements by hand using the sliders \
                in the sidebar.")
